    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page">Edit Categories</li>
            </ol>
        </nav>
    </div>
</div>
								...
								<form action="code.php" method="POST" enctype="multipart/form-data">
									<div class="row">
										<div class="col-md-12 mb-2">
											...
											<input type="text" placeholder="Enter Category Name" name="name" value="<?= $data['name'] ?>" class="form-control">
										</div>
										<div class="col-md-12 mb-2">
											<label class="mb-2" for="">Slug</label>
											<input type="text" placeholder="Enter Category Name" name="slug" value="<?= $data['slug'] ?>" class="form-control">
										</div>
										<div class="col-md-12 mb-2">
										...
										<div class="col-md-12 mb-2">
											<label class="mb-2" for="">Mete Description</label>
										...
										<div class="col-md-12 mb-2">
											<label class="mb-2" for="">Meta Keywords</label>
											<textarea rows="3" name="meta_keywords" placeholder="Enter Meta Keywords" class="form-control"><?= $data['meta_keyword'] ?></textarea>
										</div>
										...
										<div class="col-md-3 mb-2">
											<label for="" class="mb-2">Popular</label>
											<input type="checkbox" <?= $data['popular'] ? "checked" : "" ?> name="popular">
										</div>
										<div class="col-md-12 mb-2">
											<button type="submit" class="btn btn-primary radius-30 px-4" name="update_category_btn">Update Category</button>
										</div>
									</div>
								</form>
						<?php
