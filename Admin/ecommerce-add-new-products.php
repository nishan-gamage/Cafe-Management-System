    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page">Add New Products</li>
            </ol>
        </nav>
    </div>
</div>
							...
							<form action="code.php" method="POST" enctype="multipart/form-data">
								<div class="row">
									...
									<div class="col-md-6 mb-2">
										...
										<input type="text" placeholder="Enter Category Name" required name="name" class="form-control mb-2">
									</div>
									<div class="col-md-6 mb-2">
										<label class="mb-0">Slug</label>
										<input type="text" placeholder="Enter Slug" required name="slug" class="form-control mb-2">
									</div>
									<div class="col-md-6 mb-2">
										<label class="mb-0">Original Price</label>
										<input type="text" placeholder="Enter Original Price" required name="original_price" class="form-control mb-2">
									</div>
									<div class="col-md-6 mb-2">
										<label class="mb-0">Selling Price</label>
										<input type="text" placeholder="Enter Selling Price" required name="selling_price" class="form-control mb-2">
									</div>
									<div class="col-md-6 mb-2">
										<label class="mb-0">Quantity</label>
										<input type="number" placeholder="Enter Quantity" required name="qty" class="form-control mb-2">
									</div>
									<div class="col-md-3">
									...
									<div class="col-md-12 mb-2">
										...
										<input type="text" placeholder="Enter Meta Title" required name="meta_title" class="form-control mb-2">
									</div>
									<div class="col-md-12 mb-2">
									...
									<div class="col-md-12 mb-2">
										<button type="submit" class="btn btn-primary radius-30 px-4" name="add_product_btn">Add Product</button>
									</div>
								</div>
							</form>
						</div>
