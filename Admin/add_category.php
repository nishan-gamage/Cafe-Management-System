    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active text-white" aria-current="page">Add Categories</li>
            </ol>
        </nav>
    </div>
</div>
						...
						<form action="code.php" method="POST" enctype="multipart/form-data">
							<div class="row">
								...
								<div class="col-md-12 mb-2">
									...
									<input type="text" placeholder="Enter Meta Title" name="meta_title" class="form-control">
								</div>
								<div class="col-md-12 mb-2">
								...
								<div class="col-md-12 mb-2">
									<button type="submit" class="btn btn-primary radius-30 px-4" name="add_category_btn">Add Category</button>
								</div>
							</div>
						</form>
					</div>
